...
# **An example of using the cd command with a path to the directory as an argument**
...
# **An example of using the ls command with no arguments**
...
# **An example of using the ls command with a path to the directory as an argument**
